 ...
 * @version:  V1.0
 */
public class SelectReceiveBankCardActivity extends BaseFragmentActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().add(R.id.func_container, SelectReceiveBankCardFragment.getInstance(getIntent())).commit();
	}
	...
	public void onClick(View arg0) {
		...
		case R.id.title_right_btn_three://点击添加
			FragmentTransaction ft = getSupportFragmentManager().beginTransaction().replace(R.id.func_container, AddReceiveBankCardFragment.create());
