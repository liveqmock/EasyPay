 ...
 * 
 */
public class OneMonthFragment extends BaseFragment implements OnClickListener,OnItemClickListener,OnRefreshListener{
	...
	private static final String ONE_MONTH_KEY_STRING="ONE_MONTH_KEY_STRING";
	private String whereString;
	
	public static OneMonthFragment create(String typeString){
		OneMonthFragment fragment = new OneMonthFragment();
		Bundle bundle = new Bundle();
		bundle.putString(ONE_MONTH_KEY_STRING, typeString);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		whereString = getArguments().getString(ONE_MONTH_KEY_STRING);
		mTask = new OrderTask();
		mTask.execute("");
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		try {
			...
			intent.putExtra(OrderIndex.ORDER_KEY_STRING, OrderIndex.ORDER_ONE_MONTH);
	...
	private void loadMore(){
		Logger.d("ORDER", "mLoadedCount"+mLoadedCount+"mTotalCount"+mTotalCount);
