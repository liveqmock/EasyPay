...
import com.inter.trade.ui.fragment.waterelectricgas.WaterElectricGasCityRecordFragment;
 ...
 *
 */
public class WaterElectricGasCityRecordActivity extends FragmentActivity{
...
//				TransferType.USUAL_TRANSER:getIntent().getStringExtra(TransferRecordFragment.TYPE_STRING);
		...
		fragmentTransaction.add( R.id.func_container,new WaterElectricGasCityRecordFragment());
