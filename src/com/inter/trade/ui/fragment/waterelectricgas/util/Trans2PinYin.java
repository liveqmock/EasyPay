...
public class Trans2PinYin {
	public static String[] pinYinString = new String[] {
		"上海", "北京", "广州", "深圳", "东莞", "中山","珠海", "茂名", "汕头", 
		"桂林", "兰州", "临汾", "泰安", "玉树藏族自治州", "邯郸","青岛", "龙岩", "泉州", 
		"衡阳", "岳阳", "安庆", "铜陵", "福州", "温州","昆明", "娄底", "杭州", 
		"重庆", "南京", "武汉", "成都", "郑州", "哈尔滨","烟台", "济南", "宁波", 
		"莆田", "邢台", "厦门", "南昌", "淄博", "滨州","平凉", "天水", "天津", 
		"益阳", "株洲", "阜阳", "黄山", "洛阳", "河源","湛江", "阳江", "肇庆", 
		"佛山", "韶关", "江门", "云浮", "汕尾", "梅州","潍坊", "石家庄", "滁州", 
		"日照", "长沙", "长春", "丹东",
	};
	
	public static String[] companyString = new String[] {
		"华中自来水公司", "南方电网公司", "北方天燃气公司", 
		"华中自来水公司2", "南方电网公司2", "北方天燃气公司2", 
...
     */
	 ...
	 * 处理多音字
	 * */
	public String polyphoneHandle(String result){
		String[] polyphone    = {"zhongqing", "zhaoyang", "yueshan", "danxian", "shenfang", "chengdou", "junxian", "shamen", "weili",}; 
		String[] polyphoneNew = {"chongqing", "chaoyang", "leshan", "shanxian", "shifang", "chengdu", "xunxian", "xiamen", "yuli",}; 
		int total = polyphone.length;
		for(int n=0; n<total; n++){
			if(result.equals(polyphone[n])){
				result = polyphoneNew[n];
				break;
			}
		}
		return result;
