...
public class QMoneyPaySuccessFragment extends BaseFragment{
	private LayoutInflater mInflater;
	private static ArrayList<HashMap<String, String>> mMaps = new ArrayList<HashMap<String,String>>();
	
	public static QMoneyPaySuccessFragment createFragment(ArrayList<HashMap<String, String>> cData){
		QMoneyPaySuccessFragment fragment = new QMoneyPaySuccessFragment();
		mMaps = cData;
		return fragment;
	}
	public QMoneyPaySuccessFragment(){
	...
	private void initResult(View view){
		...
		btnAgain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(FragmentFactory.INDEX_KEY, FuncMap.QMONEY_INDEX_FUNC);
