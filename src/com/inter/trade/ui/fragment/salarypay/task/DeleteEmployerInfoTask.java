...
import com.inter.trade.ui.fragment.salarypay.parser.DeleteEmployerInfoParser;
 ...
 * @version: V1.0
 */
public class DeleteEmployerInfoTask extends AsyncTask<String, Void, Void> {

	private Context context;
	private ResponseStateListener listener;

	public DeleteEmployerInfoTask(Context context,
	...
	protected Void doInBackground(String... params) {
		try {
			...
			mData.putValue("id", params[0]);
			mData.putValue("bossauthorid", params[1]);

			List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas(
					"ApiWageInfo", "DeleteSalaryItem", mData);
			DeleteEmployerInfoParser myParser = new DeleteEmployerInfoParser();
