 ...
 *
 */
public class NewMobileAuthActivity extends FragmentActivity{
...
//		LoginUtil.detection(this);
		...
		if(bundle != null){
			transaction.replace(R.id.func_container, new NewMobileAuthFragment(bundle));
		}else{
			transaction.replace(R.id.func_container, new NewMobileAuthFragment());
		}
		transaction.commit();
	}
	...
	private void payResult(Intent data){
        ...
        new BuySuccessTask(this, resultData,"ApiMoblieRechangeInfo","checkRechaMoneyStatus").execute("");
        ...
        builder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (str.equalsIgnoreCase("success")) {
	                	 FragmentTransaction transaction = NewMobileAuthActivity.this.getSupportFragmentManager().beginTransaction();
	 	        		transaction.replace(R.id.func_container,TelephonePaySuccessFragment.createFragment(mCommonData,false));
	 	        		transaction.commit();
                }else{
                		finish();
                }
