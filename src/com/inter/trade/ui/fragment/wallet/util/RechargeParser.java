package com.inter.trade.ui.fragment.wallet.util;
 ...
 *
 */
public class RechargeParser extends NetParser{
		...
		if (body.mChildren != null && body.mChildren.size() > 0) {
			...
			for(String key:keys){
				...
				for(ProtocolData data: rs){
					...
					}else if(data.mKey.equals("cardno")){
						serializer.startTag("", "cardno");
						serializer.text(data.mValue.trim());
						serializer.endTag("", "cardno");
					...
					}else if(data.mKey.equals("cardmobile")){
						serializer.startTag("", "cardmobile");
						serializer.text(data.mValue.trim());
						serializer.endTag("", "cardmobile");
						
					}else if(data.mKey.equals("cardman")){
						serializer.startTag("", "cardman");
						serializer.text(data.mValue.trim());
						serializer.endTag("", "cardman");
