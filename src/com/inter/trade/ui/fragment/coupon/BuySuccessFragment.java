...
public class BuySuccessFragment extends BaseFragment{
	...
	public static BuySuccessFragment createFragment(ArrayList<HashMap<String, String>> cData){
		BuySuccessFragment fragment = new BuySuccessFragment();
		mMaps = cData;
		return fragment;
	}
	public BuySuccessFragment(){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.coupon_buy_success, container,false);
//		ListView mListView = (ListView)view.findViewById(R.id.result_listview);
	...
	private void initResult(View view){
		...
		see_history.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				FragmentUtil.startFuncActivity(getActivity(), FragmentFactory.BUY_RECORD_INDEX);
				getActivity().setResult(Constants.ACTIVITY_FINISH);
				getActivity().finish();
			}
		});
		...
		btnAgain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(FragmentFactory.INDEX_KEY, FuncMap.COUPON_INDEX_FUNC);
