...
import com.inter.trade.ui.fragment.buyhtbcard.HTBBuyMainFragment.AgentOrderData;
 ...
 *
 */
public class HTBBuyHistoryAdapter extends BaseAdapter{
...
//	private Holder mHolder = null;
	...
	public HTBBuyHistoryAdapter(Context context,ArrayList<AgentOrderData> datas){
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		if(convertView == null)
		{
			convertView = mInflater.inflate(R.layout.htb_buycard_item, null);
			mHolder = new Holder();
...
//				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas("ApiExpresspayInfo", "agentorderstaterq",
//						data);
