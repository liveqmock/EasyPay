...
public class CouponListAdapter extends BaseAdapter{
	...
	private ArrayList<Coupon> mBankDatas;
	
	public CouponListAdapter(Context context,ArrayList<Coupon> datas){
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		mHolder.name.setText(mBankDatas.get(arg0).couponmoney+" 元");
		return convertView;
	}
	class Holder{
		TextView name;
