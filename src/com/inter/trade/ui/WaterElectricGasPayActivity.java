...
import com.inter.trade.ui.fragment.waterelectricgas.WaterElectricGasPayConfirmFragment;
 ...
 *
 */
public class WaterElectricGasPayActivity extends FragmentActivity{
	...
	public static WaterElectricGasPayData payData = new WaterElectricGasPayData();
...
//		LoginUtil.detection(this);
		...
		Bundle bundle = getIntent().getBundleExtra("payInfo");
		
		FragmentManager fragmentManager = getSupportFragmentManager();
		
		FragmentTransaction transaction = fragmentManager.beginTransaction();
		if(bundle != null){
			transaction.replace(R.id.func_container, new WaterElectricGasPayConfirmFragment(bundle));
		}else{
			transaction.replace(R.id.func_container, new WaterElectricGasPayConfirmFragment());
		}
		transaction.commit();
	}
...
//        resultData.putValue(ResultData.unionPaySerialNumber, mBankNo);
        ...
        new BuySuccessTask(this, resultData,"ApiUtility","completeOrder").execute("");
        ...
        builder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (str.equalsIgnoreCase("success")) {
	                	 FragmentTransaction transaction = WaterElectricGasPayActivity.this.getSupportFragmentManager().beginTransaction();
