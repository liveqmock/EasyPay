...
import com.inter.trade.ui.fragment.agent.AgentApplyFragment;
 ...
 *
 */
public class AgentApplyActivity extends FragmentActivity{
...
//		LoginUtil.detection(this);
		...
		if(bundle != null){
			transaction.replace(R.id.func_container, new AgentApplyFragment(bundle));
		}else{
			transaction.replace(R.id.func_container, new AgentApplyFragment());
		}
		transaction.commit();
	}
