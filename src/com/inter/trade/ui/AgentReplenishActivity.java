...
import com.inter.trade.ui.fragment.agent.AgentReplenishFragment;
 ...
 *
 */
public class AgentReplenishActivity extends FragmentActivity{
...
//		LoginUtil.detection(this);
		...
		if(bundle != null){
			transaction.replace(R.id.func_container, new AgentReplenishFragment(bundle));
		}else{
			transaction.replace(R.id.func_container, new AgentReplenishFragment());
		}
		transaction.commit();
	}
