 ...
 * @version:  V1.0
 */
public class QMoneyCreditCardTask extends AsyncTask<String, Void, Void> {
	
	private Context context;
	
	private ResponseStateListener listener;
	private CommonData qqData;
	
	public QMoneyCreditCardTask(Context context, ResponseStateListener listener, CommonData qqData) {
		super();
	...
	protected Void doInBackground(String... params) {
			...
			try {
				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas(
						"ApiyibaoPayInfo", "qqrechargeReq", qqData);
				QMoneyCreditCardParser authorRegParser = new QMoneyCreditCardParser();
