...
public class WaterElectricGasCitySearchAdapter extends BaseAdapter implements SectionIndexer{
...
//		mArrayList= datas;
//	}
	public WaterElectricGasCitySearchAdapter(Context context,ArrayList<WaterElectricGasData> datas){
		this.mContext = context;
		mInflater = LayoutInflater.from(mContext);
		mResources=context.getResources();
		mArrayList= datas;
