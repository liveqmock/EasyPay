...
//	public  final static String INTENT_ACTION_CALL_STATE = "com.gdseed.mobilereader.CALL_STATE";
...
////	protected MobileReader mobileReader;
...
//	protected SwipListener mSwipListener; // 刷卡回掉接口
...
//
////	protected boolean isSwipIn = false; // 是否插入刷卡器
////	public static String mKeyCode = null; // 刷卡器设备号
//
////	 protected boolean isSwipIn=true;
////	 public static String mKeyCode="00000000000000";
//
////	public StringBuffer merReserved = new StringBuffer();// 银行卡保留域
//
...
//
//	private boolean isSendCmd = false;//true发送命令读取设备号。
//	protected static final String CMD_KNS = "07";// 读取设备号命令
//	private Timer mTimer;
//	protected KeyData mKeyData = new KeyData();
	protected SwipKeyTask mKeyTask;
	@Override
	public boolean handleMessage(Message msg) {
		// TODO Auto-generated method stub
//		if (msg.what == OPEN_READER) {
//			boolean falg = mobileReader.open(false);
//			log("flag: " + falg);
...
////		if(null == mobileReader){
//			mobileReader = new MobileReader(PayApp.pay);
////		}
////		mobileReader = MobileReaderCreator.createMobileReader();
...
//		if(isSwipIn){
//			boolean flag = mobileReader.open(playSounds);
...
//	}
//	
//	protected boolean  openReaderNow(){
//		if(isSwipIn){
//			return mobileReader.open(playSounds);
//		}
//		return false;
//	}
//
...
//
	...
	/**
	 * 设置返回事件,当前Activity的Fragment压栈后，按返回可回退Fragment
	 */
	 ...
	 * @param title
	 */
	protected void setRightVisible(OnClickListener onClickListener,int drawable) {
		if (getActivity() == null) {
			return;
		}
		back = (Button) getActivity().findViewById(R.id.title_back_btn);
		...
		Button right = (Button) getActivity()
				.findViewById(R.id.title_right_btn_two);
		right.setVisibility(View.VISIBLE);
		Drawable bg = getActivity().getResources().getDrawable(drawable);
	...
	/**
	 * 处理超时，一般情况子类继承实现，执行再次异步操作(如果需要)
	 */
	public void onTimeout () {}
	
	
	public void showSoftBoard(View id){
		InputMethodManager imm = (InputMethodManager)getActivity().getSystemService(Context.INPUT_METHOD_SERVICE); 
		  imm.showSoftInput(id, InputMethodManager.RESULT_SHOWN); 
...
//   	        im.hideSoftInputFromInputMethod(token, 0);
...
//					if (len < 1) {
//						mobileReader.writeRecoderToFile(getCurrentFileName()
//								+ "_null.raw");
//					} else {
//						mobileReader.writeRecoderToFile(getCurrentFileName()
//								+ "_crc.raw");
...
//	 * @param cmd
//	 */
//	private void sendCmdKSN(String cmd) {
