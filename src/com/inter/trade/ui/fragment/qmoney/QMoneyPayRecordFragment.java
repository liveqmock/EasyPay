 ...
 *
 */
public class QMoneyPayRecordFragment extends BaseFragment implements OnClickListener,OnItemClickListener {
...
//	private String mType;
	public static QMoneyPayRecordFragment instance(String type){
		QMoneyPayRecordFragment fragment = new QMoneyPayRecordFragment();
	...
	public QMoneyPayRecordFragment() {
...
//				}
				...
				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas("ApiQQRechangeInfo", "readQQRechangelist",
						data);
