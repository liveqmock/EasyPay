...
import com.inter.trade.ui.fragment.coupon.parser.CheckPayStatusParser;
...
public class CheckPayStatusTask extends AsyncTask<String, Void, Void> {
	...
	public CheckPayStatusTask(Context context, ResponseStateListener listener) {
		super();
	...
	protected Void doInBackground(String... params) {
			...
			try {
				...
				mData.putValue("bkordernumber", params[0]);

				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas(
						"ApiExpresspayInfo", "couponGetStatus", mData);
				CheckPayStatusParser authorRegParser = new CheckPayStatusParser();
		...
		protected void onPostExecute(Void result) {
			...
			if (mRsp == null) {
				...
				try {
					...
					if(listener!=null){
						listener.onSuccess(LoginUtil.mLoginStatus.message, String.class);
					}
