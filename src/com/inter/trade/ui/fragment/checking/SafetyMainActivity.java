 ...
 *
 */
public class SafetyMainActivity extends FragmentActivity {
	
	public static final String TAG = SafetyMainActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle arg0) {
		...
		FragmentTransaction fragmentTransaction = fragmentManager
				.beginTransaction();
		fragmentTransaction.add(R.id.func_container, new SafetyMainFragment());
