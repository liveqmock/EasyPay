...
public class CouponMainFragment extends BaseFragment implements OnClickListener
{
	...
	private void InitViewPager()
	{
		...
		fragmentsList.add(new CouponFirstFragment());
		fragmentsList.add(new ExchangeFragment());
...
//		bmpW = SysUtil.getBitmapOptions(R.drawable.log_navigation).outWidth;// 获取图片宽度
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		mView = inflater.inflate(R.layout.log_main_layout, container, false);
		InitImageView();
		InitTextView();
		InitViewPager();
		return mView;
