...
import com.inter.trade.ui.fragment.returndaikuan.DaikuanSuccessFragment;
import com.inter.trade.ui.fragment.returndaikuan.ReturnConfirmFirstFragment;
import com.inter.trade.ui.fragment.returndaikuan.ReturnConfirmFragment;
import com.inter.trade.ui.fragment.returndaikuan.util.DaikuanData;
import com.inter.trade.util.Constants;

public class DaikuanActivity extends FragmentActivity{
...
//		LoginUtil.detection(this);
		...
		transaction.replace(R.id.func_container, ReturnConfirmFragment.create(mBankNo));
		transaction.commit();
	}
	...
	private void payResult(Intent data){
        ...
        builder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (str.equalsIgnoreCase("success")) {
	                	 FragmentTransaction transaction = DaikuanActivity.this.getSupportFragmentManager().beginTransaction();
	 	        		transaction.replace(R.id.func_container,DaikuanSuccessFragment.createFragment(mCommonData));
	 	        		transaction.commit();
                }else{
                		finish();
                }
