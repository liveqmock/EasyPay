...
import com.inter.trade.ui.creditcard.parser.EditBankCardParser;
 ...
 * @version:  V1.0
 */
public class EditBankCardTask extends AsyncTask<String, Void, Void> {
	
	private Context context;
	
	private ResponseStateListener listener;
	
	public EditBankCardTask(Context context, ResponseStateListener listener) {
		super();
	...
	protected Void doInBackground(String... params) {
			...
			try {
				...
				mData.putValue("bkcardid",  params[11]);
				
				mData.putValue("bkcardfudefault",  params[12]);
				mData.putValue("bkcardshoudefault",  params[13]);

				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas(
						"ApiAuthorKuaibkcardInfo", "EditKuaibkcard", mData);
				EditBankCardParser authorRegParser = new EditBankCardParser();
