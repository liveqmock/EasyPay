 ...
 *
 */
public class GetBindFinancialParser extends NetParser {
		...
		if (body.mChildren != null && body.mChildren.size() > 0) {
			...
			for(String key:keys){
				...
				for(ProtocolData data: rs){
					if(data.mKey.equals("authorusername")){
						serializer.startTag("", "authorusername");
						serializer.text(data.mValue.trim());
						serializer.endTag("", "authorusername");
