...
import com.inter.trade.ui.OderHistoryActivity;
 ...
 * 
 */
public class OrderPayFragment extends BaseFragment implements OnClickListener,OnItemClickListener,OnRefreshListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setRightVisible(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(getActivity(), OderHistoryActivity.class);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		try {
			...
			intent.putExtra(OrderIndex.ORDER_KEY_STRING, OrderIndex.ORDER_WAIT_PAY);
			getActivity().startActivity(intent);
		} catch (Exception e) {
	...
	public class OrderTask extends AsyncTask<String, Integer, Boolean> {
		...
		protected Boolean doInBackground(String... arg0) {
			...
			try {
				...
				data.putValue("orderstate", "nopay");
		...
		protected void onPostExecute(Boolean result) {
			...
			if (mRsp == null) {
				...
				try {
					...
					if(mAdapter ==null){
						mAdapter =new OrderWaitAdapter(getActivity(), mOrderBean.mOrderDatas);
