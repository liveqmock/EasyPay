...
public class HotelPayConfirmFragment extends BaseFragment implements OnClickListener,SwipListener, 
...
//	private TextView acount;
	 ...
	 */
	private final boolean isCreditCardPayOnly = true;
...
//	private Bundle bundle;
	...
	public static HotelPayConfirmFragment create(double value,String couponId){
		return new HotelPayConfirmFragment();
	}
	
	public HotelPayConfirmFragment()
	{
	}
	
	public HotelPayConfirmFragment(Bundle b) {
//		this.bundle = b;
	}
	
	public static HotelPayConfirmFragment newInstance (Bundle data) {
		HotelPayConfirmFragment fragment = new HotelPayConfirmFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.hotel_swip_layout, container,false);
		initView(view);
...
//		open_name_edit = (EditText)view.findViewById(R.id.open_name_edit);
		...
		((TextView)view.findViewById(R.id.tv_price)).setText("￥"+mHotelOrderData.price);
		((TextView)view.findViewById(R.id.tv_dayTotal)).setText(mHotelOrderData.dayCount);
		((TextView)view.findViewById(R.id.tv_roomTotal)).setText(mHotelOrderData.roomCount);
		((TextView)view.findViewById(R.id.tv_moneyTotal)).setText("￥"+mHotelOrderData.payMoney);
