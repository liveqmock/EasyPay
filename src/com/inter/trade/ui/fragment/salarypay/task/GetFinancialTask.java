...
import com.inter.trade.ui.fragment.salarypay.parser.GetFinancialParser;
 ...
 * @version:  V1.0
 */
public class GetFinancialTask extends AsyncTask<String, Void, Void> {
	
	private Context context;
	private ResponseStateListener listener;
	
	public GetFinancialTask(Context context, ResponseStateListener listener) {
		super();
	...
	protected Void doInBackground(String... params) {
		try {
			...
			List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas("ApiWageInfo", 
					"readcwAuthorInfo", mData);
			GetFinancialParser myParser = new GetFinancialParser();
