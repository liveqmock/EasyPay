...
public class GameRechargeGameAdapter extends BaseAdapter implements SectionIndexer{
...
//	private ArrayList<WaterElectricGasData> mArrayList;
	...
	public GameRechargeGameAdapter(Context context,ArrayList<String> datas){
...
//						if (StringMatcher.match(String.valueOf(mArrayList.get(j).cityNameTag.charAt(0)), String.valueOf(k)))
						if (StringMatcher.match(String.valueOf(mArrayList.get(j).charAt(0)), String.valueOf(k)))
							return j;
					}
				} else {
//					if (StringMatcher.match(String.valueOf(mArrayList.get(j).cityNameTag.charAt(0)), String.valueOf(mSections.charAt(i))))
					if (StringMatcher.match(String.valueOf(mArrayList.get(j).charAt(0)), String.valueOf(mSections.charAt(i))))
						return j;
				}
			}
		}
