 ...
 *
 */
public class MyBankAddFragment extends BaseFragment implements OnClickListener{
	
	private MyBankAddCreditCardFragment mAddCreditCardFragment;
	private MyBankAddBankCardFragment mAddBankCardFragment;
	...
	public static MyBankAddFragment create(){
		return new MyBankAddFragment();
	}
	
	public MyBankAddFragment()
	{
	}
...
//			switchFragment(mAddCreditCardFragment, mAddBankCardFragment);
	...
	public void switchFragment(int index){  
	    ...
	    if(mAddCreditCardFragment == null){
	    	mAddCreditCardFragment = new MyBankAddCreditCardFragment();
	    	ft=ft.add(R.id.mybank_container, mAddCreditCardFragment);
	    }
	    if(mAddBankCardFragment == null){
	    	mAddBankCardFragment = new MyBankAddBankCardFragment();
