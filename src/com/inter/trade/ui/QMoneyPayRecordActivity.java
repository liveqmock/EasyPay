...
import com.inter.trade.ui.fragment.qmoney.QMoneyPayRecordFragment;
 ...
 *
 */
public class QMoneyPayRecordActivity extends FragmentActivity{
...
//				TransferType.USUAL_TRANSER:getIntent().getStringExtra(TransferRecordFragment.TYPE_STRING);
		...
		fragmentTransaction.add( R.id.func_container,new QMoneyPayRecordFragment());
