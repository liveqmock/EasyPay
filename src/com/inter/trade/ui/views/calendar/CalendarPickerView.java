...
package com.inter.trade.ui.views.calendar;
...
import com.inter.trade.ui.views.calendar.MonthCellDescriptor.RangeState;
...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    titleTextColor =
        a.getColor(R.styleable.CalendarPickerView_cpv_titleTextColor, R.color.calendar_text_active);
    headerTextColor =
  ...
  private class DefaultOnInvalidDateSelectedListener implements OnInvalidDateSelectedListener {
    @Override public void onInvalidDateSelected(Date date) {
      ...
      Toast.makeText(getContext(), "亲,当天之前的日期不能选择", Toast.LENGTH_SHORT).show();
    }
  }
}
