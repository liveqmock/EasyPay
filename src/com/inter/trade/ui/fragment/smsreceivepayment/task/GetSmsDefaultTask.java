 ...
 * @version:  V1.0
 */
package com.inter.trade.ui.fragment.smsreceivepayment.task;
 ...
 * @version:  V1.0
 */
public class GetSmsDefaultTask extends AsyncTask<String, Void, Void> {
	
	private Context context;
	
	private ResponseStateListener listener;
	
	public GetSmsDefaultTask(Context context, ResponseStateListener listener) {
		super();
	...
	protected Void doInBackground(String... params) {
			...
			try {
				...
				mData.putValue("bkcardshoudefault", params[1]);
		...
		protected void onPostExecute(Void result) {
			...
			if (mRsp == null) {
				...
				try {
					...
					if(listener!=null){
						/**
						 * Retcode ==200,返回失败，bankcard=null
						 */
						if(ProtocolUtil.ERROR_USER_DEFINE.equals(LoginUtil.mLoginStatus.mResponseData.getRetcode())){
							bankcard=null;
						}
