...
public class BuySwipCardPaySuccessFragment extends BaseFragment{
	private LayoutInflater mInflater;
	private static ArrayList<HashMap<String, String>> mMaps = new ArrayList<HashMap<String,String>>();
	
	public static BuySwipCardPaySuccessFragment createFragment(ArrayList<HashMap<String, String>> cData){
		BuySwipCardPaySuccessFragment fragment = new BuySwipCardPaySuccessFragment();
		mMaps = cData;
		return fragment;
	}
	public BuySwipCardPaySuccessFragment(){
