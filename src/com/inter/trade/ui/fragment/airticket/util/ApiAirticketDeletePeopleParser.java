 ...
 *
 */
public class ApiAirticketDeletePeopleParser extends NetParser<String> {
		...
		if (body.mChildren != null && body.mChildren.size() > 0) {
			...
			for(String key:keys){
				...
				for(ProtocolData data: rs){
					...
					else if(data.mKey.equals("id")){//乘机人、联系人ID
						serializer.startTag("", "id");
						serializer.text(data.mValue.trim());
						serializer.endTag("", "id");
					}else if(data.mKey.equals("type")){//删除信息类型，1代表删除乘机人；2代表删除联系人
