...
import com.inter.trade.ui.creditcard.parser.CaiSmsCodeParser;
 ...
 * @version:  V1.0
 */
public class CaiSmsCodeTask extends AsyncTask<String, Void, Void> {
	...
	public CaiSmsCodeTask(Context context, ResponseStateListener listener) {
		super();
	...
	protected Void doInBackground(String... params) {
			...
			try {
				...
				mData.putValue("SMSCode", params[0]);
				mData.putValue("bkordernumber", params[1]);
				mData.putValue("bkntno", params[2]);
				mData.putValue("verifytoken", params[3]);

				List<ProtocolData> mDatas = ProtocolUtil.getRequestDatas(
						params[4], params[5], mData);
				CaiSmsCodeParser authorRegParser = new CaiSmsCodeParser();
		...
		private void showAgainLoadDialog () {
			...
			.setPositiveButton("重试", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					new CaiSmsCodeTask(context, listener).execute(params);
				}
