...
public class CridetRechageFragment extends BaseFragment implements OnClickListener,SwipListener{
...
//	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.recharge_cridet_layout, container,false);
		initView(view);
...
//		isSwipIn = true;
		...
		ConfirmFragment.mRechargeData.putValue(JournalData.merReserved, Base64Pay.encode(PayApp.merReserved.toString().getBytes()));
		return true;
	}
	@Override
