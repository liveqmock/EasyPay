 ...
 *
 */
public class AgentQueryActivity extends FragmentActivity{
...
//		LoginUtil.detection(this);
		...
		if(bundle != null){
			transaction.replace(R.id.func_container, new AgentQueryFragment(bundle));
		}else{
			transaction.replace(R.id.func_container, new AgentQueryFragment());
		}
		transaction.commit();
	}
