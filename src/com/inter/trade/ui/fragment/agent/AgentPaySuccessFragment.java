...
public class AgentPaySuccessFragment extends BaseFragment{
	private LayoutInflater mInflater;
	private static ArrayList<HashMap<String, String>> mMaps = new ArrayList<HashMap<String,String>>();
	
	public static AgentPaySuccessFragment createFragment(ArrayList<HashMap<String, String>> cData){
		AgentPaySuccessFragment fragment = new AgentPaySuccessFragment();
		mMaps = cData;
		return fragment;
	}
	public AgentPaySuccessFragment(){
