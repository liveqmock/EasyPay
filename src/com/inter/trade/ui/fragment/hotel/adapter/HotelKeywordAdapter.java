 ...
 *
 */
public class HotelKeywordAdapter extends BaseExpandableListAdapter{
	private Context mContext;
	private LayoutInflater mInflater;
	private Resources mResources;
	private List<String> mGroupList;
	private ArrayList<ArrayList<HotelKeywordData>> mChildList;
...
//	String[][] str_child_items_2 = {{}, {"200.00", "200.00", "28.00"}, {"4280.00"}};
	...
	public HotelKeywordAdapter(Context context, List<String> groupList, ArrayList<ArrayList<HotelKeywordData>> childList){
