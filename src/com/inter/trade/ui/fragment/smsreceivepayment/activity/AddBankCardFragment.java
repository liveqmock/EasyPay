...
public class AddBankCardFragment extends BaseFragment implements OnClickListener, IFavoriteCharacterDialogListener{
	...
	public static AddBankCardFragment create(Bundle b){
		return new AddBankCardFragment(b);
	}
	...
	public AddBankCardFragment(Bundle b)
	{
		this.bundle = b;
	}
...
//		View view = inflater.inflate(R.layout.mybank_creditcard_edit_layout, container,false);
		View view = inflater.inflate(R.layout.sms_bankcard_add_layout, container,false);
		initView(view);
